package DukeLeto2.chillager_mod.mobs.renderers.models;
...
public class ChillagerEntityModel<T extends ChillagerEntity> extends CompositeEntityModel<T> implements ModelWithArms, ModelWithHead {
    //private static Identifier TEXTURE = new Identifier("minecraft:textures/entity/illager/evoker.png");
    ...
    public ChillagerEntityModel(float scale, float pivotY, int textureWidth, int textureHeight) {
        super();

        // super(entityRenderDispatcher, new IllagerEntityModel(0,0,64,64), 0.5f);
   ...
   /* public ChillagerEntityModel(EntityRenderDispatcher entityRenderDispatcher, ChillagerEntityModel chillagerEntityModel, float v) {
    }*/
    ...
    @Override
    public void setAngles(T ChillagerEntity, float f, float g, float h, float i, float j) {
      ...
      /*  IllagerEntity.State state = illagerEntity.getState();
       ...
       // boolean bl = state == IllagerEntity.State.CROSSED;
        ...
        this.leftAttackingArm.visible = false;
        this.rightAttackingArm.visible = false;
    }
    @Override
